...
3、https://github.com/hyq2019/nav/settings/secrets/actions/new 添加申请的 token， name 填写 `TOKEN` 大写。

4、打开 https://github.com/hyq2019/nav/actions 开启 action 自动部署

5、修改项目根目录配置文件 [package.json](package.json) 只需要修改仓库地址 `gitRepoUrl` 字段

6、打开 https://hyq2019.github.io/nav 就能看到一个非常强大的导航网站了。
